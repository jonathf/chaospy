...
function*::
    ...
    >>> print(distribution.pdf(t).round(4))
...
Similarly to create values from the *cumulative distribution function*::
    ...
    >>> print(distribution.cdf(t).round(4))
...
*random number generator*::
    ...
    >>> print(distribution.sample(6).round(4))
...
low-discrepancy Hammersley sequences samples combined with antithetic variates::
    ...
    >>> print(distribution.sample(size=6, rule="H", antithetic=True).round(4))
